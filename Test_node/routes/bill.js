...
router.post('/generatorReport',auth.authenticateToken,(req,res)=>{
    ...
    connection.query(query,[orderDetails.name,generatorUuid,orderDetails.email,orderDetails.contactNumber,orderDetails.paymentMethod,orderDetails.totalAmount,orderDetails.productDetails,res.locals.email],(err,results)=>{
